...
$(document).ready(function () {
    ...
    $(document.body).on('change', '#add_doctor', function () {
        ...
        if (v == 'add_new' || v == 'external') {
            $('.pos_doctor').show();
            // Optional: You might want to toggle required attributes here similar to add_payment_view.js
            // But lab.js didn't seem to have them originally. 
            // We'll rely on backend validation or add them if needed. 
            // Let's at least make Name required if we can target it.
