...
class Slide extends MX_Controller {
    ...
    public function addNew() {
        ...
        $this->form_validation->set_rules('title', 'Title', 'trim|required|min_length[1]|max_length[500]|xss_clean');
        // Validating Text 1 Field
        $this->form_validation->set_rules('text1', 'Text 1', 'trim|required|min_length[1]|max_length[500]|xss_clean');
        // Validating Text 2 Field
        $this->form_validation->set_rules('text2', 'Text 2', 'trim|required|min_length[1]|max_length[500]|xss_clean');
        // Validating Text 3 Field
        $this->form_validation->set_rules('text3', 'Text 3', 'trim|required|min_length[1]|max_length[500]|xss_clean');
        ...
        $this->form_validation->set_rules('status', 'Status', 'trim|required|min_length[1]|max_length[500]|xss_clean');
