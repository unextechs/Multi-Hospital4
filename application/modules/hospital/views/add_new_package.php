                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">
                                <?php echo lang('Add new package by selecting modules and inserting other information'); ?>
                            </h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            ...
                            <form role="form" action="hospital/package/addNew" method="post"
                                enctype="multipart/form-data">
                                <div class="form-row">
                                    <div class="col-md-6">

                                        <div class="form-group">
                                            <label for="exampleInputEmail1"> <?php echo lang('package'); ?>
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputEmail1"> <?php echo lang('patient'); ?>
                                                <?php echo lang('limit'); ?> &ast; </label>
                                            <input type="text" class="form-control form-control-lg" name="p_limit"
                                                value='<?php
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputEmail1"> <?php echo lang('doctor'); ?>
                                                <?php echo lang('limit'); ?> &ast; </label>
                                            <input type="text" class="form-control form-control-lg" name="d_limit"
                                                value='<?php
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputEmail1"> <?php echo lang('monthly_price'); ?> &ast;
                                            </label>
                                            <input type="text" class="form-control form-control-lg" name="monthly_price"
                                                value='<?php
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputEmail1"> <?php echo lang('yearly_price'); ?> &ast;
                                            </label>
                                            <input type="text" class="form-control form-control-lg" name="yearly_price"
                                                value='<?php
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">
                                                <?php echo lang('show_in_frontend'); ?></label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            ?>>
                                            <label for="exampleInputEmail1">
                                                <?php echo lang('set_as_default'); ?></label>
                                        </div>
                                    ...
                                    <div class="">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <br>
                                            <input type='checkbox' value="frontend" name="module[]" <?php
                                            if (!empty($package->id)) {
                                                if (in_array('frontend', $modules1)) {
                                                    echo 'checked';
                                                }
                                            } else {
                                                echo 'checked';
                                            ...
                                            <br>
                                            <input type='checkbox' value="ai_patient_overview" name="module[]" <?php
                                            if (!empty($package->id)) {
                                                if (in_array('ai_patient_overview', $modules1)) {
                                                    echo 'checked';
                                                }
                                            } else {
                                                echo 'checked';
                                            ...
                                            ?>>
                                            <?php echo lang('ai_patient_overview'); ?>
                                            <br>
                                            ...
                                            <br>
                                            <input type='checkbox' value="hl7" name="module[]" <?php
                                            if (!empty($package->id)) {
                                                if (in_array('hl7', $modules1)) {
                                                    echo 'checked';
                                                }
                                            } else {
                                                echo 'checked';
                                            ...
                                            <br>
                                            <input type='checkbox' value="dicom" name="module[]" <?php
                                            if (!empty($package->id)) {
                                                if (in_array('dicom', $modules1)) {
                                                    echo 'checked';
                                                }
                                            } else {
                                                echo 'checked';
                                            ...
                                            DICOM
                                            <br>
                                            <input type='checkbox' value="settings" name="module[]" <?php
                                            if (!empty($package->id)) {
                                                if (in_array('settings', $modules1)) {
                                                    echo 'checked';
                                                }
                                            } else {
                                                echo 'checked';
                                            ...
                                            <br>
                                            <input type='checkbox' value="insurance" name="module[]" <?php
                                            if (!empty($package->id)) {
                                                if (in_array('insurance', $modules1)) {
                                                    echo 'checked';
                                                }
                                            } else {
                                                echo 'checked';
