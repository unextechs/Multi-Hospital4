                            ...
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    <h3 class="document-title mb-1">MEDICAL PRESCRIPTION
                                        #RX-<?php echo str_pad($prescription->id, 5, '0', STR_PAD_LEFT); ?></h3>
                                    <p class="document-subtitle mb-0">
                                        <?php // Doctor name and date removed from header as per request (date moved to logo, doctor removed) ?>
                                    </p>
                                </div>
                        ...
                        <div class="document-content">
                            ...
                            <div class="document-section mb-4 text-center border-0">
                                <?php if (!empty($settings->logo)): ?>
                                    <img src="<?php echo $settings->logo; ?>" class="hospital-logo mb-3"
                                        alt="Hospital Logo">
                                    <br>
