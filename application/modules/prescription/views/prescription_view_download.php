            ...
            <div class="bg_prescription">
                <div class="panel-body text-center">
                    <?php if (!empty($settings->logo)): ?>
                        <div class="top_logo mb-3">
                            <img src="<?php echo $settings->logo; ?>" height="100"
                                style="max-height: 100px; object-fit: contain;">
                        </div>
                    <?php endif; ?>
                    <div class="top_title">
                        <h2 class='doctor' style="font-weight: bold; margin-bottom: 5px;">
                            <?php echo $settings->title; ?>
                        </h2>
                        <h4 style="margin-bottom: 5px;"><?php echo $settings->address; ?></h4>
                        <h4 style="margin-bottom: 0;">Tel: <?php echo $settings->phone; ?></h4>
                        <?php if (!empty($doctor)): ?>
                            <h4 class="mt-2" style="font-style: italic; color: #555;">
                                <?php echo $doctor->name . (!empty($doctor->title) ? ' (' . $doctor->title . ')' : ''); ?> -
                ...
                <div class="panel-body">
                    <div class="">
                        <h5 class="col-md-4 prescription"><?php echo lang('date'); ?> :
                            <?php echo date('d-m-Y', $prescription->date); ?>
                        </h5>
                        <h5 class="col-md-3 prescription"><?php echo lang('prescription'); ?> <?php echo lang('id'); ?>
                            : <?php echo $prescription->id; ?></h5>
                    </div>
                </div>
                ...
                <div class="panel-body">
                    <div class="">
                        ...
                        <h5 class="col-md-2 patient text-right"><?php echo lang('gender'); ?>:
                    ...
                    <div class="col-md-5 left_panel">
                        ...
                        <div class="panel-body">
                            <div class="float-left">
                                <h5><strong><?php echo lang('history'); ?>: </strong> <br> <br>
                                    <?php echo $prescription->symptom; ?></h5>
                            </div>
                        </div>
                        ...
                        <div class="panel-body">
                            <div class="float-left">
                                <h5><strong><?php echo lang('note'); ?>:</strong> <br> <br>
                                    <?php echo $prescription->note; ?></h5>
                            </div>
                        </div>
                        ...
                        <div class="panel-body">
                            <div class="float-left">
                                <h5><strong><?php echo lang('advice'); ?>: </strong> <br> <br>
                                    <?php echo $prescription->advice; ?></h5>
                            </div>
                        </div>
            ...
            <div class="panel-primary clearfix">
                ...
                <div class="panel_button clearfix">
                    <div class="text-center invoice-btn no-print float-left download_button">
                        <a class="btn btn-info btn-sm detailsbutton float-left download" id="download"><i
                ...
                <div class="panel_button clearfix">
                    <?php if ($this->ion_auth->in_group(array('admin'))) { ?>
                        <div class="text-center invoice-btn no-print float-left">
                            <a class="btn btn-info btn-lg info" href='prescription/all'><i class="fa fa-medkit"></i>
                                <?php echo lang('all'); ?>     <?php echo lang('prescription'); ?> </a>
                        </div>
                    <?php } ?>
                    <?php if ($this->ion_auth->in_group(array('Doctor'))) { ?>
                        <div class="text-center invoice-btn no-print float-left">
                            <a class="btn btn-info btn-lg info" href='prescription'><i class="fa fa-medkit"></i>
                                <?php echo lang('all'); ?>     <?php echo lang('prescriptions'); ?> </a>
                        </div>
                    <?php } ?>
                </div>
                <div class="panel_button">
                    <?php if ($this->ion_auth->in_group(array('admin', 'Doctor'))) { ?>
                        <div class="text-center invoice-btn no-print float-left">
                            <a class="btn btn-info btn-lg green" href="prescription/addPrescriptionView"><i
                                    class="fa fa-plus-circle"></i> <?php echo lang('add_prescription'); ?> </a>
                        </div>
                    <?php } ?>
                </div>
            </div>
