    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title font-weight-bold" id="wModalLabel"><?= lang('please_wait'); ?></h4>
            </div>
...
<script type="text/javascript">
    var restore_confirm = "<?php echo lang('restore_confirm'); ?>";
</script>
<script type="text/javascript">
    var restore_modal_heading = "<?php echo lang('restore_modal_heading'); ?>";
</script>
<script type="text/javascript">
    var backup_modal_heading = "<?php echo lang('backup_modal_heading'); ?>";
</script>
<script type="text/javascript">
    var delete_confirm = "<?php echo lang('delete_confirm'); ?>";
</script>
<script type="text/javascript">
    var href_file = "<?php echo site_url('settings/backup_files'); ?>";
</script>
