<form role="form" action="appointment/addNew" id="addAppointmentForm" method="post" class="clearfix"
        ...
        <div id="followup_buttons_container" class="mt-3 mb-4" style="display: none;">
            <div class="row no-gutters">
                <div class="col-6 pr-1">
                    <button type="button"
                        class="btn btn-outline-primary btn-sm btn-block py-2 font-weight-bold shadow-sm"
                        id="btn_new_appointment" style="border-width: 2px;">
                        <i class="fas fa-calendar-plus mb-1 d-block"></i>
                        NEW VISIT
                    </button>
                </div>
                <div class="col-6 pl-1">
                    <button type="button"
                        class="btn btn-outline-success btn-sm btn-block py-2 font-weight-bold shadow-sm"
            ...
            <div id="followup_status_text" class="small mt-2 text-center font-weight-bold"></div>
        </div>
    </div>
    ...
    <div class="col-md-6 panel">
        ...
        <input type="text" class="form-control form-control-lg default-date-picker" autocomplete="off" id="date"
            onkeypress="return false;" name="date" id="exampleInputEmail1" value='' placeholder="" required>
    </div>
    ...
    <div class="col-md-12 panel">
        ...
        <select class="form-control form-control-lg m-bot15" name="visit_description" id="visit_description" value=''
            required>
            ...
            <div class="cardPayment">
                ...
                <?php if ($payment_gateway == '2Checkout' || $payment_gateway == 'PayPal') {
                    ...
                    <div class="col-md-12 payment pad_bot">
                        ...
                        <input type="text" id="cardholder" class="form-control pay_in" name="cardholder" value=''
                            placeholder="">
                    </div>
                <?php } ?>
                <?php if ($payment_gateway != 'Pay U Money' && $payment_gateway != 'Paystack' && $payment_gateway != 'SSLCOMMERZ' && $payment_gateway != 'Paytm') { ?>
                    ...
                    <div class="col-md-8 payment pad_bot">
                        ...
                        <input type="text" class="form-control pay_in" id="expire" data-date="" data-date-format="MM YY"
                    ...
                    <div class="col-md-4 payment pad_bot">
                        ...
                        <input type="text" class="form-control pay_in" id="cvv" maxlength="3" name="cvv" value=''
                            placeholder="">
                    </div>
                    <?php
                }
