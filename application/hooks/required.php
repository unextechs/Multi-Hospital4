...
function required()
{
    ...
    if ($CI->router->fetch_class() == 'site' && $CI->router->fetch_method() == 'index') {
        ...
        $common = array('payu', 'status', 'macro', 'auth', 'pservice', 'settings', 'import', 'home', 'profile', 'request', 'api', 'cronjobs', 'logs', 'doctorvisit', 'site', 'testpkz', 'facilitie', 'faq', 'diagnosis', 'treatment', 'symptom', 'advice', 'inventory', 'emergency', 'ambulance', 'dashboard', 'radiology', 'dental', 'role_permission', 'frontend', 'hl7', 'dicom', 'tv', 'workspace');
